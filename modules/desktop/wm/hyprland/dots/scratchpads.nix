...
in
{
  ...
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "$mainMod, L, exec, hyprland-scratchpad --raise-or-run-uwsm io.github.xiaoyifang.goldendict_ng goldendict"
    ]
    ...
    windowrulev2 = [
      ...
      "tag +float_side, class:io.github.xiaoyifang.goldendict_ng"
      "stayfocused, class:io.github.xiaoyifang.goldendict_ng"
      ...
      "noanim, class:io.github.xiaoyifang.goldendict_ng"
