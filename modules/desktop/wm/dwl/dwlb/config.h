...
static pixman_color_t active_bg_color = HEX_COLOR(0x1e1e2eff);
...
static pixman_color_t urgent_fg_color = HEX_COLOR(0xf38ba8ff);
static pixman_color_t urgent_bg_color = HEX_COLOR(0x1e1e2eff);
